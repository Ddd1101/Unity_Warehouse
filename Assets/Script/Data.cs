...
public class Data : MonoBehaviour
{
    ...
    public static int[] C_in = { 8, 95, 113, 113, 103, 64, 100, 87, 79, 79, 70, 70 };
    ...
    public static Queue<GameObject> A_object_store = new Queue<GameObject>();
    public static Queue<GameObject> B_object_store = new Queue<GameObject>();
    public static Queue<GameObject> C_object_store = new Queue<GameObject>();
